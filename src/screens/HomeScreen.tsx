...
const HomeScreen = () => {
    ...
    const categories = [ALL, ...[...new Set(homeItems?.map((item: { category: string; }) => item.category))]]
    useEffect(() => {
    ...
    const renderCategoryItem = (category: any) => {
        ...
        >
            <Text style={[styles.categoryText, isActive && styles.activeCategoryText]}>{category.item?.toUpperCase()}</Text>
        </TouchableOpacity>
    }

    const filteredItems = selectedCategory === ALL
        ? homeItems
        : homeItems.filter((item: { category: string; }) => item.category === selectedCategory);
